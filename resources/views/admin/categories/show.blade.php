      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
          <tr>
            ...
            <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">問題文</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-4 py-3 text-lg text-gray-900">
                    <form method="POST" action="{{ route('admin.categories.quizzes.destroy',['categoryId' => $category->id,'quizId' => $quiz->id]) }}">
                    @csrf
                    <button class="flex ml-auto text-white bg-red-600 border-0 py-2 px-6 focus:outline-none hover:text-red-800 rounded">削除</button>
                    </form>
