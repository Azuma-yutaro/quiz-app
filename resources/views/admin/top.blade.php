...
<section class="text-gray-600 body-font relative">
  <div class="container px-5 py-7 mt-5 mx-auto">
      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
        ...
        <tbody>
            ...
            <tr>
                ...
                <button class="flex ml-auto text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded">詳細</button>
                </td>
                <td class="px-4 py-3 text-lg text-gray-900">
                    <button class="flex ml-auto text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded">削除</button>
                </td>
